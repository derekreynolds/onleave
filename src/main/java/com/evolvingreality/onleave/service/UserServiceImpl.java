...
public class UserServiceImpl extends EntityServiceImpl<User> implements UserService {
    ...
    /* (non-Javadoc)
	 * @see com.evolvingreality.onleave.service.UserServiceI#completePasswordReset(java.lang.String, java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.evolvingreality.onleave.service.UserServiceI#requestPasswordReset(java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.evolvingreality.onleave.service.UserServiceI#updateUserInformation(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.evolvingreality.onleave.service.UserServiceI#changePassword(java.lang.String)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.evolvingreality.onleave.service.UserServiceI#getUserWithAuthorities()
	 */
    @Override
	@Transactional(readOnly = true)
    public User getUserWithAuthorities() {
        User currentUser = userRepository.findOneByEmail(SecurityUtils.getCurrentLogin()).get();
        currentUser.getGroupMembers()
        	.stream()
        	.forEach(member -> member.getSecurityGroup().getAuthorities().size()); // eagerly load the association
        return currentUser;
    }

    /* (non-Javadoc)
	 * @see com.evolvingreality.onleave.service.UserServiceI#removeNotActivatedUsers()
	 */
    @Override
