...
@Configuration
@EnableJpaRepositories("com.evolvingreality.onleave.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.evolvingreality.onleave.config.HerokuDatabaseConfiguration")
